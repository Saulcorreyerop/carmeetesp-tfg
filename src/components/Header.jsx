    ...
    <header className="header">
      ...
      {menuAbierto && (
        <nav className="header-nav-mobile">
          ...
          <Link to="/eventos" onClick={() => setMenuAbierto(false)}>Eventos</Link>
          <Link to="/mapa" onClick={() => setMenuAbierto(false)}>Mapa</Link>
          {session ? (
            <>
            ...
            <Link to="/login" onClick={() => setMenuAbierto(false)}>Entrar</Link>
          )}
        </nav>
      )}
    </header>
